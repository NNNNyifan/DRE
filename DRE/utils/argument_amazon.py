...
def arg_parser_preprocessing():
    ...
    parser.add_argument("--sentires_dir", dest="sentires_dir", type=str, default="./datasets/Cell_Phones/Cleaned_reviews_Cell_Phones_and_Accessories_5.json", 
                        help="path to pre-extracted sentires data")
    parser.add_argument("--review_dir", dest="review_dir", type=str, default="./datasets/Cell_Phones/Cleaned_reviews_Cell_Phones_and_Accessories_5.json", 
                        help="path to original review data")
    #------加入discription-----
    parser.add_argument("--description_dir", dest="description_dir", type=str, default="./datasets/Cell_Phones/meta_Cell_Phones_and_Accessories.json.gz", 
                        help="path to original description data")
    #--------------------------
    ...
    parser.add_argument("--review_num", dest="review_num", type=int, default=3)
        
    # parser.add_argument("--user_max", dest="user_max", type=int, default=10, 
    # help="remove users with reviews more than this threshold")
    parser.add_argument("--feature_thresh", dest="feature_thresh", type=int, default=1000, 
    help="remove the features mentioned less than this threshold")
    parser.add_argument("--llm_model", dest="llm_model", type=str,default="chat-gpt-3.5",
    help="choose llm to explain recommend item"
    )
    parser.add_argument("--recommed_type", dest="recommed_type", type=str, default="movie_and_TV",
    help="help gpt to know recommended type")
    parser.add_argument("--delay_time",dest="delay_time",type=int,default=0,
    help="to solve the openai request limit")
...
def arg_parse_exp_optimize():
    ...
    parser.add_argument("--gpu", dest="gpu", action="store_false", help="whether to use gpu")
    parser.add_argument("--cuda", dest="cuda", type=str, default='1', help="which cuda")
